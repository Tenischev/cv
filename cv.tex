...
\begin{center}
    ...
    \small +357 95924835 $|$ \href{mailto:tenischev.semen@gmail.com}{\underline{tenischev.semen@gmail.com}} $|$
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Lead the design and development of software solutions, working closely with stakeholders to translate business needs into technical specifications}
        \resumeItem{Drive iterative development cycles, incorporating user feedback to continuously improve solution quality and usability}
        \resumeItem{Collaborate effectively with other teams to align solutions, define APIs, and leverage existing system knowledge}
        \resumeItem{Identify and implement improvements to core libraries and infrastructure to enhance development efficiency}
      \resumeItemListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Java, SQL (PL/SQL, Postgres), Kotlin, TypeScript, JavaScript, HTML/CSS, C++, C} \\
     \textbf{Frameworks}{: Spring Boot, Spring Framework, Apache Camel, Apache Kafka, React, Gradle, Maven, Flyway, Liquibase, JUnit, Testcontainers, Docker, Rancher, OpenAPI} \\
