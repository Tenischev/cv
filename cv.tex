...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Chief Technology Officer (CTO)}{April 2022 -- Present}
      ...
      \resumeItemListStart
        ...
        \resumeItem{Project and product risk management in technical aspects}
        \resumeItem{Global vision for products technology development}
    ...
    \resumeSubheading
      ...
      {Neos}{Saint-Petersburg, Russia}
      \resumeItemListStart
        \resumeItem{Improving company development flow for 4 scrum teams}
        \resumeItem{Mentoring PO and conduct series of meet-ups for leads}
        \resumeItem{Synchronisation of development capabilities with business commitments}
        \resumeItem{Improving scrum practices in the company}
      \resumeItemListEnd
